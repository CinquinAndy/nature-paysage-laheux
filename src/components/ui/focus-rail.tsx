  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-1 flex-col justify-center px-4 md:px-8">
        ...
        <motion.div
          className="relative mx-auto flex h-[300px] md:h-[360px] w-full max-w-6xl items-center justify-center perspective-[1200px] cursor-grab active:cursor-grabbing"
          drag="x"
        ...
        >
          {visibleIndices.map((offset) => {
            ...
            const blurValue = isCenter ? 0 : dist * 6;
        ...
        <div className="mx-auto mt-8 md:mt-12 flex w-full max-w-4xl flex-col items-center justify-between gap-6 md:flex-row pointer-events-auto">
          <div className="flex flex-1 flex-col items-center text-center md:items-start md:text-left h-24 md:h-32 justify-center">
