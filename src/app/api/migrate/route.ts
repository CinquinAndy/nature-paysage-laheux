			...
			await payload.updateGlobal({
				...
				data: {
					...
					values: {
						...
						valuesList: [
							...
							},
							{
								...
								description:
									'Basé à Monnières, je connais parfaitement le climat et les sols de Loire-Atlantique.',
							},
							{
								icon: 'trending-down',
								number: '04',
					...
					philosophy: {
						...
						philosophyPoints: [
							...
							},
							{
								...
								description:
									'Compostage, paillage, broyage : rien ne se perd, tout se transforme pour nourrir le sol.',
							},
							{
								icon: 'shield',
								title: 'Engagement Qualité',
								description:
									'Travail soigné, conseil personnalisé et transmission des bonnes pratiques écologiques.',
							},
						],
						preferences: [
					...
					taxCredit: {
						...
						subtitle:
							"Tous mes services d'entretien de jardin sont éligibles au crédit d'impôt Services à la Personne",
